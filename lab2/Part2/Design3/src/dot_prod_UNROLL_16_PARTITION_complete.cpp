...
#pragma HLS INTERFACE s_axilite port = return bundle = control
    ...
    #pragma HLS ARRAY_PARTITION variable=va_buffer   complete
    #pragma HLS ARRAY_PARTITION variable=vb_buffer   complete
    #pragma HLS ARRAY_PARTITION variable=vout_buffer complete
