...
set IPName      "dot_prod"
set Version     "1.0"
set DisplayName "Dot_prod"
set Revision    "2113773568"
...
set xo_kernel_name "dot_prod"
set xo_kernel_files {/home/centos/src/project_data/aws-fpga/Vitis/examples/xilinx_2021.2/l2_part2_d1/src/dot_prod.cpp}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/centos/src/project_data/aws-fpga/Vitis/examples/xilinx_2021.2/l2_part2_d1/_x.hw_emu.xilinx_aws-vu9p-f1_shell-v04261818_201920_3/dot_prod/dot_prod/dot_prod/solution"
set debug_dir "/home/centos/src/project_data/aws-fpga/Vitis/examples/xilinx_2021.2/l2_part2_d1/_x.hw_emu.xilinx_aws-vu9p-f1_shell-v04261818_201920_3/dot_prod/dot_prod/dot_prod/solution/.debug"
set xo_hls_files_dir "/home/centos/src/project_data/aws-fpga/Vitis/examples/xilinx_2021.2/l2_part2_d1/_x.hw_emu.xilinx_aws-vu9p-f1_shell-v04261818_201920_3/dot_prod/dot_prod/dot_prod/solution/impl/ip/hls_files"
set hdl_module_list {dot_prod_flow_control_loop_pipe_sequential_init
dot_prod_mul_32s_32s_32_2_1
dot_prod_flow_control_loop_pipe_sequential_init
...
set kernel_xo "/home/centos/src/project_data/aws-fpga/Vitis/examples/xilinx_2021.2/l2_part2_d1/_x.hw_emu.xilinx_aws-vu9p-f1_shell-v04261818_201920_3/dot_prod/dot_prod/dot_prod/solution/impl/export.xo"

## Variables
set Top "dot_prod"
set TopNoPrefix "dot_prod"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_EN RW 0 {Enable Channel 2 (ap_local_deadlock) Interrupt.  0 = Disabled, 1 = Enabled.}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup}} {2 3 RESERVED_0 R 0 {Reserved.  0s on read.}} {5 1 CHAN2_INT_ST RTOW 0 {Channel 2 (ap_local_deadlock) Interrupt Status. 0 = No Channel 2 input interrupt, 1 = Channel 2 input interrup}} {6 26 RESERVED_1 R 0 {Reserved.  0s on read.}}}} {0x10 vec_a_1 W 0x0 "Data signal of vec_a" {{0 32 vec_a W 0 "Bit 31 to 0 of vec_a"}}} {0x14 vec_a_2 W 0x0 "Data signal of vec_a" {{0 32 vec_a W 0 "Bit 63 to 32 of vec_a"}}} {0x1c vec_b_1 W 0x0 "Data signal of vec_b" {{0 32 vec_b W 0 "Bit 31 to 0 of vec_b"}}} {0x20 vec_b_2 W 0x0 "Data signal of vec_b" {{0 32 vec_b W 0 "Bit 63 to 32 of vec_b"}}} {0x28 results_1 W 0x0 "Data signal of results" {{0 32 results W 0 "Bit 31 to 0 of results"}}} {0x2c results_2 W 0x0 "Data signal of results" {{0 32 results W 0 "Bit 63 to 32 of results"}}} {0x34 vector_len W 0x0 "Data signal of vector_len" {{0 32 vector_len W 0 "Bit 31 to 0 of vector_len"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 184 II x}
