...
set C_modelName {dot_prod}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 512 regular {axi_master 2}  }
	{ vec_a int 64 regular {axi_slave 0}  }
	{ vec_b int 64 regular {axi_slave 0}  }
	{ results int 64 regular {axi_slave 0}  }
	{ vector_len int 32 unused {axi_slave 0}  }
	{ ap_local_deadlock int 1 unused {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READWRITE", "bitSlice":[ {"cElement": [{"cName": "vec_a","offset": { "type": "dynamic","port_name": "vec_a","bundle": "control"},"direction": "READONLY"},{"cName": "vec_b","offset": { "type": "dynamic","port_name": "vec_b","bundle": "control"},"direction": "READONLY"},{"cName": "results","offset": { "type": "dynamic","port_name": "results","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "results", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} , 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"dot_prod","role":"start","value":"0","valid_bit":"0"},{"name":"dot_prod","role":"continue","value":"0","valid_bit":"4"},{"name":"dot_prod","role":"auto_start","value":"0","valid_bit":"7"},{"name":"vec_a","role":"data","value":"16"},{"name":"vec_b","role":"data","value":"28"},{"name":"results","role":"data","value":"40"},{"name":"vector_len","role":"data","value":"52"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"dot_prod","role":"start","value":"0","valid_bit":"0"},{"name":"dot_prod","role":"done","value":"0","valid_bit":"1"},{"name":"dot_prod","role":"idle","value":"0","valid_bit":"2"},{"name":"dot_prod","role":"ready","value":"0","valid_bit":"3"},{"name":"dot_prod","role":"auto_start","value":"0","valid_bit":"7"},{"name":"ap_local_deadlock","role":"data","value":"0"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "5", "8", "9"],
		...
		"Port" : [
			...
			{"Name" : "results", "Type" : "None", "Direction" : "I"},
			{"Name" : "vector_len", "Type" : "None", "Direction" : "I"},
			{"Name" : "ap_local_deadlock", "Type" : "None", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.va_buffer_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.vb_buffer_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dot_prod_Pipeline_load_fu_150", "Parent" : "0", "Child" : ["4"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dot_prod_Pipeline_load_fu_150.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dot_prod_Pipeline_compute_fu_158", "Parent" : "0", "Child" : ["6", "7"],
	...
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dot_prod_Pipeline_compute_fu_158.mul_32s_32s_32_2_1_U5", "Parent" : "5"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dot_prod_Pipeline_compute_fu_158.flow_control_loop_pipe_sequential_init_U", "Parent" : "5"},
