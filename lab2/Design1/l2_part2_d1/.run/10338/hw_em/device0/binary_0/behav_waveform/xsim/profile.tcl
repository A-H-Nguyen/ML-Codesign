...
proc getTraceEvents {kernelName cuName moduleName signal targetValue {requireEnd 0}} {
  ...
  set startTimeMsec 0
  set factor 9.0
  set currDeviceName xilinx_aws-vu9p-f1_shell-v04261818_201920_3-0
  set currBinaryName dot_prod_app
...
# Compute Unit Stalls
#
set computeUnits { dot_prod_1 }
set cuFullPaths { /emu_wrapper/emu_i/dynamic_region/dot_prod_1/inst/ }
...
# Function Stalls
#
set computeUnits { dot_prod_1 dot_prod_1 }
set cuFullPaths { /emu_wrapper/emu_i/dynamic_region/dot_prod_1/inst/ /emu_wrapper/emu_i/dynamic_region/dot_prod_1/inst/ }
set modules { grp_dot_prod_Pipeline_load_fu_150 grp_dot_prod_Pipeline_compute_fu_158 }
set realModules { dot_prod_Pipeline_load dot_prod_Pipeline_compute }
...
set readBusySignals { /emu_wrapper/emu_i/dynamic_region/dot_prod_1/m_axi_gmem.readActive }
set writeBusySignals { /emu_wrapper/emu_i/dynamic_region/dot_prod_1/m_axi_gmem.writeActive }
...
# Set list of CU, modules, protoinst for kernel dot_prod at index 0 in " kernels " list declared later 
set cuForKernel0 { dot_prod_1  } 
set cuPathForKernel0 { /emu_wrapper/emu_i/dynamic_region/dot_prod_1/inst/  } 
set moduleForKernel0 { grp_dot_prod_Pipeline_load_fu_150 grp_dot_prod_Pipeline_compute_fu_158  } 
set protoInstForKernel0 { grp_dot_prod_Pipeline_load_fu_150 grp_dot_prod_Pipeline_compute_fu_158  } 

set kernels { dot_prod }
